...
|---|---|---|---|---|---|---|---|
| ![/W_Cats_HighCompression.png](/W_Cats_HighCompression.png) | ![/W_Cats_HighCompression.png](/W_Cats_HighCompression.png) | ![/W_Cats_HighCompression.png](/W_Cats_HighCompression.png) | ![/W_Cats_HighCompression.png](/W_Cats_HighCompression.png) | ![/W_Cats_HighCompression.png](/W_Cats_HighCompression.png) | ![/W_Cats_HighCompression.png](/W_Cats_HighCompression.png) | ![/W_Cats_HighCompression.png](/W_Cats_HighCompression.png) | ![/W_Cats_HighCompression.png](/W_Cats_HighCompression.png) |
| First boot | First boot | First boot | First boot | First boot | First boot | First boot | First boot |
| ![/W_Aqua_HighCompression.png](/W_Aqua_HighCompression.png) | ![/W_Modern1_HighCompression.png](/W_Modern1_HighCompression.png) | ![/W_Modern1_HighCompression.png](/W_Modern1_HighCompression.png) | ![/W_Modern1_HighCompression.png](/W_Modern1_HighCompression.png) | ![/W_Modern1_HighCompression.png](/W_Modern1_HighCompression.png) | ![/W_Modern1_HighCompression.png](/W_Modern1_HighCompression.png) | ![/W_Modern1_HighCompression.png](/W_Modern1_HighCompression.png) | ![/W_Modern1_HighCompression.png](/W_Modern1_HighCompression.png) |
| Default boot | Default boot | Default boot | Default boot | Default boot | Default boot | Default boot | Default boot |
| Wac OS X Public "Beta" (Kodia) [Local](/WacOS_X/Public_Beta/) | Wac OS X 10.0 (Cheetah) [Local](/WacOS_X/10.0/) | Wac OS X 10.1 (Puma) [Local](/WacOS_X/10.1/) | Wac OS X 10.2 (Jaguar) [Local](/WacOS_X/10.2/) | Wac OS X 10.3 (Panther) [Local](/WacOS_X/10.3/) | Wac OS X 10.4 (Tiger) [Local](/WacOS_X/10.4/) | Wac OS X 10.5 (Leopard) [Local](/WacOS_X/10.5/) | Wac OS X 10.6 (Snow Leopard) [Local](/WacOS_X/10.6/) |
